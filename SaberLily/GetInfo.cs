...
namespace SaberLily
{
    public static class GetInfo
    {
        ...
        public static string GetTranslate(string str)
        {
            ...
            string temp = HttpClient.Get(url, "http://translate.google.cn/?sourceid=cnhp", 5000);
        ...
        private static string GetTranslate_GoogleTK(string str)
        {
            ...
            scriptEngine.SetGlobalValue("window", scriptEngine);
        ...
        public static string GetExchangeRate(string p1, string p2)
        {
            ...
            string temp = HttpClient.Get(url, "", 100000);
        ...
        public static string GetStock(string p1, string p2 = "")
        {
            ...
            string dat = HttpClient.Get(url, "", 100000, Encoding.GetEncoding("GB2312"));
